...
public class payBkash extends  JFrame implements  ActionListener  {
   ...
   public  payBkash(String s10, String s11,String s12,String s13,String s14,String s15,String s16){
	   this.s10=s10;
		this.s11=s11;
		this.s12=s12;
		this.s13=s13;
	...
	JFrame f=new JFrame("Bkash payment");
 ...
 public void mouseClicked(MouseEvent e) {
  ...
  b2=new JButton("Confirm");
	  ...
	  //background image
	  ImageIcon closeImgIcon15 = new ImageIcon("E:\\java Project\\Image\\paybkash.png");
	...
	JLabel openImg5 = new JLabel("", closeImgIcon15 , JLabel.CENTER);
	openImg5.setBounds(0,0,400,488);
	openImg5.setLayout(null);
	openImg5.setVisible(true);	
	f.add(openImg5);
      ...
      openImg5.add(b1);
	   openImg5.add(b2);
	  openImg5.add(numberLabel);
	  openImg5.add(numField);
      openImg5.add(passLabel); 
      openImg5.add(passField);
...
public static void main(String[] args) {
        new payBkash(null,null,null,null,null,null,null);
    }	
}
